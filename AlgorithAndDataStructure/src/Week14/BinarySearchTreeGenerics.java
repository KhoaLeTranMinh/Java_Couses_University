...
public class BinarySearchTreeGenerics<M extends Comparable<M>, N> {
	...
	public static void main(String[] args) {
		BinarySearchTreeGenerics<Integer, String> tree = new BinarySearchTreeGenerics<Integer, String>();
		// Test case 1
		tree.add(9, "n1");
		tree.add(5, "n2");
		tree.add(10, "n3");
	...
	public BinarySearchTreeGenerics() {
		root = null;
	}
		...
		if (goal.getLeft() == null && goal.getRight() == null) {
			...
			while (true) {
				if (current.getLeft() == goal) {
					...
					current.deleteRight();
					return true;
				} else if (goal.getKey().compareTo(current.getKey()) > 0) { // key of goal is to the right of the
																			// current
